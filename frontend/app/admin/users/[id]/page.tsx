...
export default function AdminCustomerDetailPage() {
  ...
  useEffect(() => { if (!params?.id) return; apiFetch<Customer>(`/admin/users/${params.id}`).then(setCustomer).catch((loadError) => setError(loadError instanceof Error ? loadError.message : 'Unable to load customer')); }, [params?.id]);
